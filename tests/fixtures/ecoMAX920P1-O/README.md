# ecoMAX920P1-O Test Fixtures

## Overview

This directory contains test fixtures for the **ecoMAX920P1-O** ecoNET device.
...
fixture_path = Path(__file__).parent / "fixtures" / "ecoMAX920P1-O"
