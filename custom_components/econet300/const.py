...
# Values of the "special" field that mark an entity as EntityCategory.DIAGNOSTIC.
# special=5: network status (Server, Wifi status)
# special=6: network config (Encryption)
